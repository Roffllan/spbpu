 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = ((deg + min / 60.0 + sec / 60.0 / 60.0) / 180 * PI)
 ...
 */
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double): Double = sqrt((x2 - x1).pow(2.0) + (y2 - y1).pow(2.0))
 ...
 */
fun thirdDigit(number: Int): Int = (number / 100 % 10).toInt()
